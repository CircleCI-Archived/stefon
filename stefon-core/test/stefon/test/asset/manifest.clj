(ns stefon.test.asset.manifest
  (:require [stefon.asset.manifest :as manifest]
...
(deftest test-manifest-files
  (let [manifest "test/fixtures/assets/javascripts/manifest.js.stefon"
...
(deftest test-directories-are-sorted
  (let [path "test/fixtures/assets/javascripts/sorted/"
        manifest (str path "manifest.js.stefon")
...
(deftest test-stefon-asset
  (let [manifest (asset/make-asset (io/file
                                    "test/fixtures/assets/javascripts/manifest.js.stefon"))
...
(deftest test-emacs-file
  (let [manifest (io/file "test/fixtures/assets/javascripts/emacs_test/emacs.js.stefon")
...
(deftest test-vim-file
  (let [manifest (io/file "test/fixtures/assets/javascripts/vim_test/vim.js.stefon")
        files (manifest/manifest-files manifest)]
...
(deftest test-dsstore-file
  (let [manifest (io/file "test/fixtures/assets/javascripts/dsstore_test/dsstore.js.stefon")
        files (manifest/manifest-files manifest)]
...
(deftest test-nested-directories
  (let [manifest (io/file "test/fixtures/assets/javascripts/nested-dirs.js.stefon")
        files (manifest/manifest-files manifest)]
